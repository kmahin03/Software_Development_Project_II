...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"]==="POST" && isset($_POST['submit'])){
        if(isset($_POST['emp_id']) && isset($_POST['year']) && isset($_POST['month'])){
            ...
            // header("Location: HR_payroll.php");
        }
    }
    ...
    $query4="SELECT COUNT(*) AS row_count FROM `attendance` WHERE `emp_id`='$emp_id' AND `status`='a' AND attendance_month='$Month' AND attendance_year='$Year';";
    ...
    <div class="name">
        ...
        <p>Employee Name: '. $name['emp_name'] .'</p>
    </div>
<table>
    <tr>
        <th>Basic</th>
